...
class HistoryController {
    ...
    async readTopFiveSearchedCities(req: Request, resp: Response){
        const historyService = new HistoryService()

        try {
            const historys = await historyService.readTopFiveSearchedCities();
    ...
    async readLastCities(req: Request, resp: Response) {
        const historyService = new HistoryService()
